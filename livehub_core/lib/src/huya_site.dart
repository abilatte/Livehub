...
import 'package:livehub_core/src/model/tars/get_cdn_token_ex_resp.dart';
import 'package:livehub_core/src/model/tars/get_cdn_token_req.dart';
import 'package:livehub_core/src/model/tars/get_cdn_token_resp.dart';
import 'package:livehub_core/src/model/tars/huya_user_id.dart';
...
class HuyaSite implements LiveSite {
  ...
  Future<String> getHuYaUA() async {
    ...
    try {
      var result = await HttpClient.instance.getJson(
        "https://raw.githubusercontent.com/abilatte/Livehub/master/assets/play_config.json",
        queryParameters: {
