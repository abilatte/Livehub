...
class AppSettingsController extends GetxController {
  ...
  var chatMessageRetentionLimit = 0.obs;
  ...
  var superChatRetentionLimit = 0.obs;
  ...
  var liveRoomSidebarWidth = 0.obs;
  ...
  var keepSuperChatInPage = true.obs;
  void setKeepSuperChatInPage(bool e) {
    keepSuperChatInPage.value = e;
    LocalStorageService.instance
        .setValue(LocalStorageService.kKeepSuperChatInPage, e);
  }

  var keepSuperChatInOverlay = false.obs;
  void setKeepSuperChatInOverlay(bool e) {
    keepSuperChatInOverlay.value = e;
    LocalStorageService.instance
        .setValue(LocalStorageService.kKeepSuperChatInOverlay, e);
  }

  var liveRoomPopupShowFollowList = true.obs;
  void setLiveRoomPopupShowFollowList(bool e) {
    liveRoomPopupShowFollowList.value = e;
    LocalStorageService.instance
        .setValue(LocalStorageService.kLiveRoomPopupShowFollowList, e);
  }
