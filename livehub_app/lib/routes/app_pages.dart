...
import 'package:livehub_app/modules/category/detail/category_detail_controller.dart';
import 'package:livehub_app/modules/category/detail/category_detail_page.dart';
...
import 'package:livehub_app/modules/mine/parse/parse_controller.dart';
import 'package:livehub_app/modules/mine/parse/parse_page.dart';
import 'package:livehub_app/modules/mine/account/account_controller.dart';
import 'package:livehub_app/modules/mine/account/account_page.dart';
import 'package:livehub_app/modules/mine/account/bilibili/qr_login_controller.dart';
import 'package:livehub_app/modules/mine/account/bilibili/qr_login_page.dart';
import 'package:livehub_app/modules/mine/account/bilibili/web_login_controller.dart';
import 'package:livehub_app/modules/mine/account/bilibili/web_login_page.dart';
import 'package:livehub_app/modules/settings/appstyle_setting_page.dart';
import 'package:livehub_app/modules/settings/auto_exit_settings_page.dart';
...
import 'package:livehub_app/modules/settings/danmu_shield/danmu_shield_page.dart';
import 'package:livehub_app/modules/follow_user/follow_user_controller.dart';
import 'package:livehub_app/modules/follow_user/follow_user_page.dart';
import 'package:livehub_app/modules/mine/history/history_controller.dart';
import 'package:livehub_app/modules/mine/history/history_page.dart';
import 'package:livehub_app/modules/settings/indexed_settings/indexed_settings_controller.dart';
import 'package:livehub_app/modules/settings/indexed_settings/indexed_settings_page.dart';
import 'package:livehub_app/modules/settings/other/other_settings_controller.dart';
import 'package:livehub_app/modules/settings/other/other_settings_page.dart';
import 'package:livehub_app/modules/settings/backup/backup_settings_controller.dart';
import 'package:livehub_app/modules/settings/backup/backup_settings_page.dart';
import 'package:livehub_app/modules/settings/play_settings_page.dart';
import 'package:livehub_app/modules/settings/settings_center_page.dart';
...
class AppPages {
  ...
  static final routes = [
    ...
    GetPage(
      ...
      bindings: [
        BindingsBuilder.put(
          () => AppSearchController(initialSiteId: Get.parameters["siteId"]),
        ),
      ],
    ),
    //分类详情
    ...
    //设置中心
    GetPage(
      name: RoutePath.kSettingsCenter,
      page: () => const SettingsCenterPage(),
    ),
    //备份与迁移
    GetPage(
      name: RoutePath.kSettingsBackup,
      page: () => const BackupSettingsPage(),
      bindings: [
        BindingsBuilder.put(() => BackupSettingsController()),
      ],
    ),
    //关注设置
    GetPage(
