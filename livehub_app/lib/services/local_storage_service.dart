...
class LocalStorageService extends GetxService {
  ...
  /// 聊天消息保留上限，0 表示使用默认策略
  static const String kChatMessageRetentionLimit = "ChatMessageRetentionLimit";

  /// SC 保留上限，0 表示使用默认策略
  static const String kSuperChatRetentionLimit = "SuperChatRetentionLimit";

  /// 直播间右侧栏宽度，0 表示使用默认宽度
  static const String kLiveRoomSidebarWidth = "LiveRoomSidebarWidth";
  ...
  /// SC页保留醒目留言
  static const String kKeepSuperChatInPage = "KeepSuperChatInPage";

  /// 播放器浮层保留SC
  static const String kKeepSuperChatInOverlay = "KeepSuperChatInOverlay";

  /// 播放页长按弹窗默认显示关注列表
  static const String kLiveRoomPopupShowFollowList =
      "LiveRoomPopupShowFollowList";
