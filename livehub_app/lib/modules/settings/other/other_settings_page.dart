    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            padding: AppStyle.edgeInsetsA12.copyWith(top: 8),
            child: const Text(
              "配置、关注列表和屏蔽词的导入导出已经统一收口到设置中心里的“数据与迁移 > 备份与迁移”。这里保留重置配置和日志、播放器高级设置。",
              ...
              children: [
                Obx(
                  () => SettingsSwitch(
                    ...
                    title: "开启日志记录",
                    subtitle: "开启后会记录日志，出现问题时可以直接导出诊断包给开发者排查",
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: TextButton.icon(
                          onPressed: controller.exportDiagnosticBundle,
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        visualDensity: VisualDensity.compact,
                        contentPadding:
                            AppStyle.edgeInsetsL12.copyWith(right: 4),
